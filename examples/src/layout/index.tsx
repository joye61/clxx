...
export default function() {
  ...
  return (
    <div>
      ...
      <div>
        <p className="LayoutGridTitle">2列（默认），空白0（默认），元素高度自适应</p>
        <Grid>
          <div>这是一个表格单元</div>
          <div>这是一个表格单元</div>
          <div>这是一个表格单元</div>
      ...
      <div>
        <p className="LayoutGridTitle">2列，空白0.05rem，方形单元格，空白环绕</p>
      ...
      <div>
        <p className="LayoutGridTitle">2列，空白0.05rem，方形单元格，没有空白环绕</p>
      ...
      <div>
        <p className="LayoutGridTitle">3列，空白0.05rem，自动高度，没有空白环绕</p>
