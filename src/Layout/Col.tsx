...
export function ColAround(props: FlexXYProps) {
  const { styles, attributes } = useXYStyles(props, "column", "space-around");
  return (
    <div css={styles} {...attributes}>
      {props.children}
    </div>
...
export function ColCenter(props: FlexXYProps) {
  const { styles, attributes } = useXYStyles(props, "column", "center");
  return (
    <div css={styles} {...attributes}>
      {props.children}
    </div>
...
export function ColBetween(props: FlexXYProps) {
  const { styles, attributes } = useXYStyles(props, "column", "space-between");
  return (
    <div css={styles} {...attributes}>
      {props.children}
    </div>
...
export function ColStart(props: FlexXYProps) {
  const { styles, attributes } = useXYStyles(props, "column", "flex-start");
  return (
    <div css={styles} {...attributes}>
      {props.children}
    </div>
...
export function ColEnd(props: FlexXYProps) {
  const { styles, attributes } = useXYStyles(props, "column", "flex-end");
  return (
    <div css={styles} {...attributes}>
      {props.children}
    </div>
