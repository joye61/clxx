  ...
  _createClass(ScrollView, [{
    ...
    value: function showScrollBar() {
      ...
      if (this.props.showScrollBar && this.diffRect[axis] < 0) {
        ...
        var style = (_style = {}, _defineProperty(_style, this.transformAttr, "translate3d(0, ".concat(this.state.barOffset, "px, 0)")), _defineProperty(_style, "height", "".concat(this.state.barSize, "px")), _defineProperty(_style, "top", 0), _defineProperty(_style, "right", 0), _defineProperty(_style, "width", "3px"), _style);

        if (axis === "x") {
          var _style2;

          style = (_style2 = {}, _defineProperty(_style2, this.transformAttr, "translate3d(".concat(this.state.barOffset, "px, 0, 0)")), _defineProperty(_style2, "width", "".concat(this.state.barSize, "px")), _defineProperty(_style2, "left", 0), _defineProperty(_style2, "bottom", 0), _defineProperty(_style2, "height", "3px"), _style2);
        }
